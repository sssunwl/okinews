...
TODAY_IS_DATA = [
    ...
    (2, 14, "情人節",        "💝", "生活", 3, "日本傳統由女生送巧克力，沖繩海景餐廳是最浪漫的表白舞台"),
    (2, 22, "貓の日",        "🐈", "生活", 3, "2-22音似「喵喵喵」，沖繩街頭的島貓閒散度日，是最真實的沖繩慢活寫照"),
    # ── 3月 ──
    (3,  3, "雛祭り",        "🎎", "傳統", 4, "女兒節，沖繩版雛人偶穿上琉球傳統服飾，紅型染布色彩比本土版更鮮艷"),
    (3, 21, "春分",          "🌸", "節氣", 5, "晝夜等長，沖繩珊瑚礁進入春季復甦期，水溫轉暖最適合浮潛"),
    (3, 31, "珊瑚の日",      "🪸", "海洋", 5, "守護沖繩藍的珊瑚礁紀念日，白化危機正在加速，海洋保育刻不容緩"),
    # ── 4月 ──
    ...
    (5, 22, "國際生物多樣性日","🪸","海洋", 5, "沖繩海域擁有全日本最豐富的珊瑚礁生態，是地球上最多樣的海洋環境之一"),
    (5, 25, "主婦休息日",    "☕", "生活", 2, "放下一切去沖繩咖啡店，面海的露台坐著發呆就是最奢侈的休假"),
    (5, 26, "風呂日",        "♨️", "文化", 2, "5-26諧音「お風呂」，沖繩飯店的展望露天浴加上海景是最療癒的組合"),
    ...
    (6, 15, "沖繩戰跡紀念",  "🕊️", "歷史", 4, "參觀糸滿的平和祈念公園，二戰沖繩戰役留下的傷痕是最深刻的和平教育"),
    (6, 21, "夏至",          "☀️", "節氣", 5, "全年白天最長，沖繩夏至的夕陽從那霸港灣緩緩沉入海平線，絕景"),
    ...
    (7, 20, "漢堡日",        "🍔", "文化", 3, "美軍基地帶來的飲食文化，沖繩美式漢堡店是全日本最道地的牛肉堡"),
    ...
    (8, 13, "お盆",          "🏮", "傳統", 5, "迎接祖先靈魂的盂蘭盆節，沖繩エイサー太鼓舞是全島最動人的節慶表演"),
    ...
    # ── 11月 ──
    (11,  3, "文化の日",     "🎭", "文化", 4, "首里城祭典在此時盛大登場，琉球王朝宮廷盛裝遊行是一年中最壯觀的畫面"),
    (11, 11, "沖繩泡盛祭",   "🍶", "沖繩", 5, "沖繩最大規模的泡盛慶典，百種古酒齊聚，深入了解琉球蒸餾酒文化精髓"),
    ...
    (12,  7, "大雪",         "❄️", "節氣", 3, "北國積雪的節氣，沖繩卻是日本最溫暖的冬天，20°C的海岸陽光等著你"),
    (12, 22, "冬至",         "🍋", "節氣", 5, "日本人泡柚子湯迎冬至，沖繩的冬至夜晚最長，卻是最寧靜美麗的星空"),
